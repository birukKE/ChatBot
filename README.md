...
The application consists of a Next.js frontend and a Python Flask backend.

1. The user submits a question through the web interface.
2. The Flask backend receives the question.
3. Relevant medical/academic documents are retrieved and stored/searchable using a
   vector database.
4. The retrieved information is provided as context to a Gemini language model.
